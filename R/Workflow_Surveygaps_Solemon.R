...
species<-c("Merluccius_merluccius", "Solea_solea")
years<-c(2020,2021,2022)
index<-"biomindex" #### use "abunindex" for abundance computations
#years<-c(2021)
for (specie in species){
 cat(paste0("species in progress ",specie,"\n"))
 data_path=paste0("../data/",specie,".csv")
 missing_haul_path=("../data/missing_hauls.csv")
 data_s<-read.csv(data_path)
 subset<-data_s[data_s$year != "2005" & data_s$year != "2006",]
 data<-subset[!grepl('ms|bis', subset$station),]
 #data <-subset[!(row.names(subset) %in% c("904","905","906","907","908","955","958","959","960")),]
 #data <-subset[!(row.names(subset) %in% c("581","582","583","584","585","632","635","636","960")),]
 #data<-subset[!(row.names(subset) %in% c("579","580","581","582","583","584","585","591","593","599","600","601","611","612","613","614","616","619","621","623","624","629","630","632","635","636","960","961","962")),]
 #data <-subset[!(row.names(subset) %in% c("902","903","904","905","906","907","908","914","916","922","923","924","934","935","936","937","939","942","944","945","946","947","952","953","955","958","959","960","961","962")),]
