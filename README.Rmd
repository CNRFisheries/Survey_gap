...
![Figure 1: folders tree structure](C:/Users/a.palermino/OneDrive - CNR/github/Survey_gaps/folder_structure.png)
...
At the end of each run the biomindex_outptut table is shown along with a plot showing the index estimated per missing station (from hbie_output) and Area ( from biomindex_output). Both are also stored in biomindex_output folder

![Figure 2: Example of final plot](C:/Users/a.palermino/OneDrive - CNR/github/Survey_gaps/example_outputs/Solea_solea_final_plot_2021.png)