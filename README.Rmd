...
-   Solea_solea.csv; Sepia_officinalis.csv; Melicertus_keraturus.csv; Squilla_mantis.csv; Pecten_jacobeus.csv; HaulData.csv; StrataWeight.csv: example of input data
...
Open "Workflow_Surveygaps.R" in RStudio and set working directory to "source file location"
